...
const PrivacyPolicy = () => {
    ...
    return !fontsLoaded ? <AppLoading /> : (
        <ScrollView style={{...styles.Mainview,backgroundColor: darkMode ? customDarkMode.backgroundColor : customLightMode.backgroundColor }}>
            <Header endHeading={'privacy Policy'} headingStyle={{...styles.headingStyle,color:darkMode ? customDarkMode.textColor : customLightMode.textColor}} />


            <View style={{ marginHorizontal: 20, marginTop: 55 }}>
                <Text style={{...styles.title,color:darkMode ? customDarkMode.textColor : customLightMode.textColor}}>{privacy.title}</Text>
                <Text style={[styles.title, { fontFamily: 'Poppins_700Bold',color:darkMode ? customDarkMode.textColor : customLightMode.textColor }]}>{privacy.boldText}</Text>
                <Text style={[styles.title, { fontFamily: 'Poppins_400Regular',color:darkMode ? customDarkMode.textColor : customLightMode.textColor }]}>{privacy.content}</Text>
                <Text style={[styles.title, { fontFamily: 'Poppins_400Regular',color:darkMode ? customDarkMode.textColor : customLightMode.textColor }]}>{privacy.content2}</Text>
            </View>
