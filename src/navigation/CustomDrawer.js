...
function CustomDrawer(props) {
  ...
  const { user , setDarkMode , darkMode , customDarkMode , customLightMode , setIsAuthenticated} = useContext(AuthContext)
  const toggleSwitch = () => setDarkMode(darkMode => !darkMode);
      ...
      <DrawerContentScrollView {...props}>
        ...
        <View style={{ width: "100%", flexDirection: "row" , alignItems:"center"  }}>
          <View style={{ width: "50%" , paddingLeft:15 }}>
            <Text style={{fontSize: 16 , fontWeight:"500" , color : darkMode ? 'white' : "black"}}>Dark Mode</Text>
          </View>
        ...
        <View>
          <TouchableOpacity onPress={()=> logout()} style={{width:"100%",paddingLeft:16,marginTop:10}}>
            <Text style={{fontSize: 16 , fontWeight:"500" , color : darkMode ? 'white' : "black"}}>
              Log Out
            </Text>
          </TouchableOpacity>
        </View>
